...
class GStreamerPigeonatorApp(GStreamerWatcherApp):
    """
    GStreamer app for Pigeonator.
    Inherits from GStreamerWatcherApp.
    """
    
    def __init__(self, app_callback, user_data):
        """
        Initialize the Pigeonator application.
        ...
        logger.info("Pigeonator application initialized")
        
        # Any Pigeonator-specific configuration can be added here
